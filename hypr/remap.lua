...
hl.bind(Hyper .. " + P",                                hl.dsp.exec_cmd("hyprpicker -a"))
...
hl.bind(Meh .. " + E",			        hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
local workdir = "/home/gaskia/projects/adventurer-guild"
hl.bind(Hyper .. " + w", hl.dsp.exec_cmd("$HOME/bin/workdir.sh " .. workdir))
